...
const phoneScreen = ref([
  ...
  },
  {
    ...
    liarTalk: `好的，那這裡我會幫您做通知中國信託銀行做取消，等下您可能也會接到中國信託銀行的電話會跟您確定說這筆卡真的被盜刷，你跟他說這是盜刷即可，那銀行跟我們這邊會幫您處理把這個款項給刪除`,
  },

  {
    ...
    liarTalk: `黃小姐您好，這裡是中國信託商業銀行電話客服專員，敝姓王，不好意思，剛剛這裡有收到蝦咪電商的通知，說您的信用卡有被盜刷的狀況，那基於隱私安全這裡需再次跟您確認是不是沒有做這筆消費`,
  },
  {
    photo: `p07_demoPhone_bankAccountPage01.png`,
  ...
  },
  {
    ...
    liarTalk: `好的，跟黃小姐您核對一下（一邊打字聲）您是不是在我們南京復興分行做開戶的，地址是台北市中山區南京東路三段219號，`,
  },
  {
    photo: `p07_demoPhone_bankAccountPage01.png`,
    talkBubble: `請注意惡意的詐騙集團現在在換取您對他的信任,讓您不會懷疑他的談話內容真偽性`,
    ...
    liarTalk: `好的，這裡再簡單跟您做個double check，請問您是否有在其他的銀行做開戶(當下回答有)，這裡我們ㄧ樣簡單跟您做個核對的動作，請問您的另一家銀行帳戶前四碼是二零二三，跟您核對一下黃小姐您是不是在華南銀行的民生分行開戶的？地址是台北市中山區民生東路三段，好的已跟您確認完成，真的很抱歉造成您的困擾(開始套悲情牌跟您抱歉說是電商平台的疏忽造成這麼晚才通知您真的很抱歉)，因電商平台盜刷問題讓您做這麼多確認，非常謝謝您的配合`,
  },
  {
    photo: `p07_demoPhone_bankAccountPage01.png`,
    talkBubble: `請注意惡意的詐騙集團現在在換取您對他的信任,讓您不會懷疑他的談話內容真偽性`,
  ...
  {
    photo: `p07_demoPhone_bankAccountPage01.png`, //切換網銀畫面
    talkBubble: `惡意的詐騙集團會請您輸入她的帳戶說是驗證，並故意跟您核對資料開始套您的帳戶有多少錢`,
    buttonWord: `說出大約帳戶數字`,
    no_change: false,
    audio: `callin03_7.mp3`,
    liarTalk: `然後請您開啟後進入帳戶畫面，那您可以看到您目前的存款，因金管會規定較嚴格必須先跟您核對身份為本人，那這裡簡單跟您核對一下您的目前存款數字即可，不用精確的數字大概就好，只是要做身份確認（回答金額後，對方假裝正確核對，會假裝說沒錯核對沒問題），再跟您做個第二次確認您目前的國泰世華帳戶數目大概是？`,
  },
  {
