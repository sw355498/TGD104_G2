...
export default {
    ...
    methods:{
      ...
      if (!this.isAnswered) {
        element.classList.toggle('selected'); //點擊後顏色變化的部分
        ...
        if (this.selectedAnswer === this.questions[this.questionNumber - 1].correctAnswer) {//若選擇的選項 === 跳頁過後的題目裡面的那個正確的選項
