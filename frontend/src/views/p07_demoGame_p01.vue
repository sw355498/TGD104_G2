    ...
    <section class="p07_demoGame_p01bg">
        ...
        <div class="quiz_background">
            ...
            <div class="answer_button">
                <div class="answer answer_button_01">
                    
                   
                   <p> C.領了之後拆開發現裡面根本不是自己當初買的東西，大叫倒楣被騙</p> </div>
                <div class="answer answer_button_02">
                    <!-- <img src="../assets/img/p07_demo/p07_demoGame/question_botton.png" alt=""> -->
                    <p>C.領了之後拆開發現裡面根本不是自己當初買的東西，大叫倒楣被騙</p> </div>
                <div class="answer answer_button_03">
                    <!-- <img src="../assets/img/p07_demo/p07_demoGame/question_botton.png" alt=""> -->
                    <p>A.對方的大頭貼放著帥哥美女圖，而且對方跟你網戀一段時間後就用各種名目向你要錢</p> 
                    </div>
                <div class="answer answer_button_04">
                    <!-- <img src="../assets/img/p07_demo/p07_demoGame/question_botton.png" alt=""> -->
                    <p>D.他不會情緒勒索你，強迫你交一些隱私資料，如信用卡卡號，銀行帳戶，身分證號碼等</p> 
                </div>
